...
public class MdlSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MdlGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (MdlGrammarAccess) access;
	}
	
	@Override
	protected String getUnassignedRuleCallToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		if (ruleCall.getRule() == grammarAccess.getLARule())
		...
		else if (ruleCall.getRule() == grammarAccess.getRARule())
			return getRAToken(semanticObject, ruleCall, node);
	 ...
	 * terminal RA: '}' ;
	 */
	protected String getRAToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		if (node != null)
			return getTokenText(node);
		return "}";
	}
