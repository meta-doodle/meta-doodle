 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.mdl.mdl.impl.MailImpl#getExpediteur <em>Expediteur</em>}</li>
 *   <li>{@link org.xtext.mdl.mdl.impl.MailImpl#getDestinataire <em>Destinataire</em>}</li>
 *   <li>{@link org.xtext.mdl.mdl.impl.MailImpl#getPj <em>Pj</em>}</li>
 *   <li>{@link org.xtext.mdl.mdl.impl.MailImpl#getCorps <em>Corps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MailImpl extends MinimalEObjectImpl.Container implements Mail
{
  ...
  {
    return MdlPackage.Literals.MAIL;
  }
  ...
  public void setExpediteur(String newExpediteur)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MdlPackage.MAIL__EXPEDITEUR, oldExpediteur, expediteur));
  }
  ...
  public EList<String> getDestinataire()
  {
    ...
    {
      destinataire = new EDataTypeEList<String>(String.class, this, MdlPackage.MAIL__DESTINATAIRE);
    }
    return destinataire;
  }
  ...
  public void setPj(String newPj)
  {
    ...
    pj = newPj;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MdlPackage.MAIL__PJ, oldPj, pj));
  }
  ...
  public NotificationChain basicSetCorps(Contenu newCorps, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MdlPackage.MAIL__CORPS, oldCorps, newCorps);
  ...
  public void setCorps(Contenu newCorps)
  {
    if (newCorps != corps)
    {
      ...
      if (corps != null)
        msgs = ((InternalEObject)corps).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MdlPackage.MAIL__CORPS, null, msgs);
      if (newCorps != null)
        msgs = ((InternalEObject)newCorps).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MdlPackage.MAIL__CORPS, null, msgs);
      msgs = basicSetCorps(newCorps, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MdlPackage.MAIL__CORPS, newCorps, newCorps));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MdlPackage.MAIL__EXPEDITEUR:
        return getExpediteur();
      case MdlPackage.MAIL__DESTINATAIRE:
        return getDestinataire();
      case MdlPackage.MAIL__PJ:
        return getPj();
      case MdlPackage.MAIL__CORPS:
        return getCorps();
    }
