 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.mdl.mdl.impl.DepotImpl#getIntitule <em>Intitule</em>}</li>
 *   <li>{@link org.xtext.mdl.mdl.impl.DepotImpl#getLimiteSize <em>Limite Size</em>}</li>
 *   <li>{@link org.xtext.mdl.mdl.impl.DepotImpl#getFormat <em>Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepotImpl extends MinimalEObjectImpl.Container implements Depot
{
  ...
  {
    return MdlPackage.Literals.DEPOT;
  }
  ...
  public void setIntitule(String newIntitule)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MdlPackage.DEPOT__INTITULE, oldIntitule, intitule));
  }
  ...
  public void setLimiteSize(int newLimiteSize)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MdlPackage.DEPOT__LIMITE_SIZE, oldLimiteSize, limiteSize));
  }
  ...
  public EList<String> getFormat()
  {
    if (format == null)
    {
      format = new EDataTypeEList<String>(String.class, this, MdlPackage.DEPOT__FORMAT);
    }
    return format;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MdlPackage.DEPOT__INTITULE:
        return getIntitule();
      case MdlPackage.DEPOT__LIMITE_SIZE:
        return getLimiteSize();
      case MdlPackage.DEPOT__FORMAT:
        return getFormat();
    }
