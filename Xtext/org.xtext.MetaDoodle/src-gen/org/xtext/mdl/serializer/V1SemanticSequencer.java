...
public class V1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == V1Package.eINSTANCE)
			...
			case V1Package.END_COND:
				sequence_EndCond(context, (EndCond) semanticObject); 
				return; 
			case V1Package.MAIL:
	...
	/**
	 * Contexts:
	 *     EndCond returns EndCond
	 *
	 * Constraint:
	 *     (date=DATE ParticipantsRequired=INT?)
	 */
	protected void sequence_EndCond(ISerializationContext context, EndCond semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     ((obj=QCM cond=EndCond) | (mail=Mail dateEnvoi=DATE) | (synchDate=SynchDate cond=EndCond) | depot=Depot | dateFin=DATE)
	 */
