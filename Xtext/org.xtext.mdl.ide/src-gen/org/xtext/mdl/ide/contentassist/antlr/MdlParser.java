...
import org.xtext.mdl.ide.contentassist.antlr.internal.InternalMdlParser;
...
public class MdlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MdlGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MdlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCondFinAccess().getGroup(), "rule__CondFin__Group__0");
			builder.put(grammarAccess.getCondFinAccess().getGroup_1(), "rule__CondFin__Group_1__0");
			...
			builder.put(grammarAccess.getCondFinAccess().getDateAssignment_0(), "rule__CondFin__DateAssignment_0");
			builder.put(grammarAccess.getCondFinAccess().getParticipantsRequiredAssignment_1_1(), "rule__CondFin__ParticipantsRequiredAssignment_1_1");
	...
	@Override
	protected InternalMdlParser createParser() {
		InternalMdlParser result = new InternalMdlParser(null);
