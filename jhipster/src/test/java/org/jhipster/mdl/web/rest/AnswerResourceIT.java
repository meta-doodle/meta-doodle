...
public class AnswerResourceIT {
    ...
    public static Answer createEntity(EntityManager em) {
        Answer answer = new Answer()
            ...
            .questionIdent(DEFAULT_QUESTION_IDENT)
            .type(DEFAULT_TYPE)
    ...
    public static Answer createUpdatedEntity(EntityManager em) {
        Answer answer = new Answer()
            ...
            .questionIdent(UPDATED_QUESTION_IDENT)
            .type(UPDATED_TYPE)
    ...
    public void createAnswer() throws Exception {
        ...
        assertThat(testAnswer.getStepIdent()).isEqualTo(DEFAULT_STEP_IDENT);
        assertThat(testAnswer.getQuestionIdent()).isEqualTo(DEFAULT_QUESTION_IDENT);
    ...
    public void updateAnswer() throws Exception {
        ...
        Answer testAnswer = answerList.get(answerList.size() - 1);
        assertThat(testAnswer.getStepIdent()).isEqualTo(UPDATED_STEP_IDENT);
        assertThat(testAnswer.getQuestionIdent()).isEqualTo(UPDATED_QUESTION_IDENT);
